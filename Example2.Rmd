...
# Scenario A: Identical-association assumption holds
```{r}
...
```
# Scenario B: Identical-association assumption does not hold (inverse association)
```{r}
# define which synthetic data set to use 
df_est <- xanti
...
# Scenario C: Identical-association assumption does not hold (random association)
```{r}
# define which synthetic data set to use 
df_est <- xfalse
...
# Scenario D: Identical-association assumption partially holds 
```{r}
# define which synthetic data set to use 
df_est <- xhalf
...
# The scenarios cannot be distinguished based on observable data
```{r}
